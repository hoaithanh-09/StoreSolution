...
namespace Store.Data.Migrations
{
    ...
    [Migration("20220505040039_Init_Table")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Store.Data.Entities.CategoryProduct", b =>
                {
            ...
            modelBuilder.Entity("Store.Data.Entities.Detail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Store.Data.Entities.OrderCoupon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Store.Data.Entities.OrderPayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Store.Data.Entities.OrderProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Store.Data.Entities.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Store.Data.Entities.ProductDetail", b =>
                {
                    b.Property<int>("ProductId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Store.Data.Entities.ProductImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Store.Data.Entities.ProductPrice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Store.Data.Entities.Supplier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Store.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2022, 5, 4, 21, 0, 38, 391, DateTimeKind.Local).AddTicks(3847),
                            Fullname = "admin",
            ...
            modelBuilder.Entity("Store.Data.Entities.Customer", b =>
                {
                    b.HasOne("Store.Data.Entities.Address", "Address")
                        .WithMany("Customers")
            ...
            modelBuilder.Entity("Store.Data.Entities.Order", b =>
                {
                    ...
                    b.HasOne("Store.Data.Entities.Coupon", null)
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Store.Data.Entities.OrderPayment", b =>
                {
                    ...
                    b.HasOne("Store.Data.Entities.Payment", "Payment")
                        .WithMany("OrderPayments")
            ...
            modelBuilder.Entity("Store.Data.Entities.OrderProduct", b =>
                {
                    ...
                    b.HasOne("Store.Data.Entities.ProductPrice", "ProductPrice")
                        .WithMany("OrderProducts")
            ...
            modelBuilder.Entity("Store.Data.Entities.Product", b =>
                {
                    b.HasOne("Store.Data.Entities.Supplier", "Supplier")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Store.Data.Entities.ProductDetail", b =>
                {
                    b.HasOne("Store.Data.Entities.Detail", "Detail")
