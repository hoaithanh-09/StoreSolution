    ...
    public partial class Init_Table : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CustomerId", "DateCreated", "Fullname", "Password", "ShipperId", "Username" },
                values: new object[] { 1, null, new DateTime(2022, 5, 4, 21, 0, 38, 391, DateTimeKind.Local).AddTicks(3847), "admin", "$2a$10$Vp37Kfp5vdUfTKIXAEOByegT7qruOE96ysBfKxV5ai/J1/sjZMEJK", null, "admin" });
